...
Verification commands in \texttt{VERIFY.md} (Appendix~\ref{app:repro}).
...
All commands assume a Unix shell.  See \texttt{VERIFY.md} in the repository
...
\texttt{VERIFY.md} at the repository root.
...
C5 & Reproducibility & App.\,\ref{app:repro} & \texttt{VERIFY.md}, lockfile & \texttt{pytest tests/} & 2308 tests pass \\
