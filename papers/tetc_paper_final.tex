...
\thanks{L. M. Minier is an independent researcher affiliated with University of the People, Pasadena, CA, USA (e-mail: luis.minier@uopeople.edu). ORCID: 0009-0006-7321-4167.}%
...
\begin{figure}[!t]
\centering
\includegraphics[width=\columnwidth]{figures/fig5_sparsity_comparison.pdf}
...
\begin{figure}[!t]
\centering
\includegraphics[width=0.85\columnwidth]{figures/fig7_unitarity_scaling.pdf}
...
\begin{figure}[!t]
\centering
\includegraphics[width=0.85\columnwidth]{figures/fig8_timing_scaling.pdf}
...
\begin{figure}[!t]
\centering
\includegraphics[width=\columnwidth]{figures/fig10_quantization_impact.pdf}
