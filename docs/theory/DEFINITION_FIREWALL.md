...
| "RFT concentrates golden QP signals better than FFT" | ✅ Empirical | Theorem 8 (CI-verified) |
...
|------|--------|----------------|
| `algorithms/rft/core/phi_phase_fft_optimized.py` | Legacy | "DEPRECATED: φ-phase FFT" |
